...
export function meta({}: Route.MetaArgs) {
	return [
		{ title: "Politique de confidentialité — Revioza" },
		{
			name: "description",
			content: "Politique de confidentialité de Revioza, la solution de gamification d'avis Google pour les commerçants.",
		},
	];
}
